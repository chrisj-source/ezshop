...
export const CAP_DEFS: CapDef[] = [
  ...
  { key: 'wholesale_clients', label: 'Create and edit wholesale accounts', section: 'Clients', see: 'manageWholesaleClients' },
...
export interface Caps {
  ...
  /* clients */
  /** Wholesale accounts are billing relationships, so their own tick: a shop can
      let everyone write files while only the office sets up who gets billed. */
  manageWholesaleClients: boolean;
  /* leads */
  viewLeads: boolean;
  manageLeads: boolean;
  deleteLeads: boolean;
